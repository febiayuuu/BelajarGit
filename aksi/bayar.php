...
if($_POST){
    if($_POST['aksi']=='tambah'){ //manajemen
        ...
        //perintah alokasi pembayran otomatis
        ...
        //ubah status verifikasi pembayaran (jika yang membayar adalah petugas maka status sudah verifikasi namun jika yg membayar adalah siswa/ortu maka status belum verifikasi)
        ...
        $sql="UPDATE bayar SET id_siswa='$id_siswa',keterangan=$keterangan,bukti='$bukti',id_bayar_metode='$id_bayar_metode', status_verifikasi='$status_verifikasi', nominal_bayar='$nominal_bayar',tanggal_bayar='$tanggal_bayar' WHERE id_bayar=$id_bayar";
        // echo $sql; // Cek Perintah
        mysqli_query($koneksi,$sql);
        notifikasi($koneksi);
        header('location:../index.php?p=bayar');
