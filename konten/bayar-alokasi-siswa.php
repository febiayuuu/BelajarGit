                    ...
                    <form action="aksi/bayar.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <select name="id_bayar_metode" class="form-control" readonly="readonly">
                                    <?php
                            $id_bayar_metode=$bayar['id_bayar_metode'];
                                ...
                                while($bayar_metode=mysqli_fetch_array($query_metode)){
                                    echo "<option value='$bayar_metode[id_bayar_metode]'>$bayar_metode[metode]($bayar_metode[nomor_rekening])
                                    </option>";
                                }
                            ?>
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea
                                    ...
                                    class="form-control"
                                    rows="3"
                                    placeholder="Isi dengan keterangan pembayaran seperti nama bank,nama pengirim,dll"
                                    readonly="readonly"><?= $bayar['keterangan']; ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input
                                    ...
                                    value="<?= number_format($bayar['nominal_bayar']); ?>"
                                    readonly="readonly">
