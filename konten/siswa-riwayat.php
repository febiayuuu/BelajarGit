                        ...
                        <tr class="<?=$warna; ?>">
                            ...
                            <td>
                                ...
                                <a
                                    ...
                                    href="index.php?p=tagihan-info-siswa&id_tagihan=<?=$kolom['id_tagihan']; ?>">
                    ...
                    <table id="example1" class="table table-hover table-sm">
                        ...
                        <tr>
                            ...
                            <?php
                                ...
                                <td> <a title="Detail Riwayat Pembayaran" href="index.php?p=bayar-alokasi-siswa&id_bayar=<?=$kolom['id_bayar']; ?>"><i class="fas fa-search"></i></a></td>
