                ...
                <div class="card-body">
                    ...
                    <table id="example1" class="table table-hover table-sm">
                        ...
                        <tr>
                            ...
                            <td><?= $kolom['metode']; ?></td>
                            <td><img
                                src="file/buktibayar/<?= $kolom['bukti']; ?>"
                                alt="<?= $kolom['bukti']; ?>"
                                width="100"></td>
                            ...
                            <td>
                                ...
                                <!-- indo alokasi -->
                                <a
                                    href="index.php?p=bayar-alokasi&id_bayar=<?= $kolom['id_bayar']; ?>"
                                    title="Informasi Alokasi Pembayaran">
                                ...
                                <a
                                    onclick="return confirm('Yakin akan mengkonfirmasi pembayaran ini?')"
                                    href="index.php?p=bayar-konfirmasi&id_bayar=<?=$kolom['id_bayar']; ?>"
                                ...
                                <a
                                    ...
                                    href="aksi/bayar.php?aksi=hapus&id_bayar=<?= $kolom['id_bayar']; ?>"
                                    title="Hapus Pembayaran"><i class="fas fa-trash"></i>
                        ...
                        ?>
                                            ...
                                            <button type="submit" class="btn btn-block bg-purple mt-3">
                    ...
                    <a href="index.php?p=bayar-tambah">
                        <button type="button" class="btn bg-purple btn-block mt-3">
