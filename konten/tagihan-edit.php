            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="aksi/tagihan.php" method="post">
                        ...
                        <?php if($tagihan['total_terbayar']>0){?>
                        <div class="alert alert-warning mt-3 text-center text-bold" role="alert">
                            Perhatian!!!
                            <br>
                            Data Tagihan yang bisa diubah hanya tagihan yang belum memiliki riwayat
                            pembayaran, bila ingin merubah data tersebut harap menghapus pembayaran terlebih
                            dahulu
                        </div>
                        <?php
                        } else {
                            echo "<button class='btn btn-info btn-block mt-3'><i class='fas fa-save'></i> Simpan Perubahan</button>";
                        }
                        ?>  
                    </form>
                </div>
